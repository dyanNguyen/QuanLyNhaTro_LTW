...
namespace phongtro
{
    public partial class frm_Main : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void barBtnTThai_ItemClick(object sender, ItemClickEventArgs e)
        {
            int t = 0;
            foreach (DevExpress.XtraTab.XtraTabPage tab in xtraTabControl1.TabPages)
            {
                if (tab.Text == "Trạng thái phòng")
                {
                    xtraTabControl1.SelectedTabPage = tab;
                    t = 1;
                }
            ...
            else
            {
                ...
                TabAdd a = new TabAdd();
                // Nếu chưa có TAb này thì gọi hàm Addtab xây dựng ở trên để Add Tab con vào
                a.AddTab(xtraTabControl1, "", "Trạng thái phòng", new frm_Trangthaithue());
            }
        }
        ...
        private void barBtnTTPhong_ItemClick(object sender, ItemClickEventArgs e)
        {
            int t = 0;
            foreach (DevExpress.XtraTab.XtraTabPage tab in xtraTabControl1.TabPages)
            {
                if (tab.Text == "Tính tiền phòng")
                {
                    xtraTabControl1.SelectedTabPage = tab;
                    t = 1;
                }
            ...
            else
            {
                ...
                TabAdd a = new TabAdd();
                // Nếu chưa có TAb này thì gọi hàm Addtab xây dựng ở trên để Add Tab con vào
                a.AddTab(xtraTabControl1, "", "Tính tiền phòng", new TinhTienTro_HHH());
            }
        }

        private void barBtnDichVu_ItemClick(object sender, ItemClickEventArgs e)
        {
            int t = 0;
            foreach (DevExpress.XtraTab.XtraTabPage tab in xtraTabControl1.TabPages)
            {
            ...
            else
            {
                ...
                TabAdd a = new TabAdd();
                // Nếu chưa có TAb này thì gọi hàm Addtab xây dựng ở trên để Add Tab con vào
                a.AddTab(xtraTabControl1, "", "Dịch vụ", new frm_TTDichVu());
            }
        }
    }
}